...
A command line application to mimic a user remotely using a vending machine; this utilizes Object Oriented Programming fundamentals and File I/O.
...
An input file: `vendingmachine.csv`.
